...
class LMDataset(Dataset):
    ...
    def __init__(
        ...
        root = "C:\\MyWork\\JupyterNote\\Teaching\\DL_Assignment4\\IDL-HW4\\hw4_data_subset\\hw4p1_data"
        ...
        for file in tqdm(self.text_files):
            ...
            transcript = "".join(map(str, np.load(os.path.join(self.text_dir,file)).tolist()))
